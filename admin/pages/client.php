    ...
    <div class="card" style="border: none;">
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-2 text-end">
                    <?php $chat = $chatMgr->getUserChat($user['id']);
                            $chatid=$chat[0]['id'];
                    ?>
                    <a class="btn btn-primary" href="<?php echo ROOT_URL.'admin/pages/message/message.php?chat='.$chatid ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16">
