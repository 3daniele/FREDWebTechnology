    ...
    <div class="col-9">
      ...
      ?>
        ...
        <h4 class="d-flex justify-content-between align-items-center mb-3">
          ...
          <span class="badge bg-secondary rounded-pill text-white"><?php echo $quantity ?> elementi nel carrello</span>
        </h4>
              ...
              <div class="row w-100">
                ...
                <div class="col-lg-2 col-6">
                  <strong class="text-primary"><?php $sum = $sum + number_format($item['quantity'] * $product->price, 2);
                                                echo number_format($item['quantity'] * $product->price, 2) ?> €</strong>
                </div>
              </div>
            </li>
          <?php endforeach; ?>
