        ...
        <div class="col-4" style="margin-left: 9px;">
            <main class="form-signin">
                <form>
                    ...
                    <br>
                    <div class="form-floating">
                        <input type="text" class="form-control" id="floatingSurname" placeholder="Cognome">
                    ...
                    <br>
                    <div class="form-floating">
                        <input type="password" class="form-control" id="floatingPassword2" placeholder="Conferma Password">
                        <label for="floatingPassword">Conferma Password</label>
                    </div>
                    <br>
                    <div class="checkbox mb-3">
                        <label>
                            <input type="checkbox" value="auth-cond"> Accetto le condizioni del sito
                        </label>
                    </div>
                    <div class="checkbox mb-3">
                        <label>
                            <input type="checkbox" value="auth-data"> Acconsento al trattamento dei dati personali
                        </label>
                    </div>
